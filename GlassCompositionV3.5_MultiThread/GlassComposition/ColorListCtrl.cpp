...
BOOL CColorListCtrl::SetHeadings( UINT uiStringID )
{
	CString strHeadings;
...
BOOL CColorListCtrl::SetHeadings( const CString& strHeadings )
{
	int iStart = 0;
...
int CColorListCtrl::AddItem( LPCTSTR pszText, ... )
{
...
BOOL CColorListCtrl::DeleteItem( int iItem )
{
...
int CALLBACK CColorListCtrl::CompareFunction( LPARAM lParam1, LPARAM lParam2, LPARAM lParamData )
{
	CColorListCtrl* pListCtrl = reinterpret_cast<CColorListCtrl*>( lParamData );
...
void CColorListCtrl::Sort( int iColumn, BOOL bAscending )
{
...
void CColorListCtrl::LoadColumnInfo()
{
...
void CColorListCtrl::SaveColumnInfo()
{
	ASSERT( m_iNumColumns > 0 );
...
BOOL CColorListCtrl::SetItemText( int nItem, int nSubItem, LPCTSTR lpszText )
{
...
int CColorListCtrl::AddItemColor(LPCTSTR pszText, COLORREF crText, COLORREF crBak)
{
